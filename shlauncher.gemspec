...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "ChangeLog", "Rakefile", "bin/shlauncher_test", "bin/tractor", "test/script", "test/script/example", "test/script/example.bak", "test/script/example~", "test/script/foo", "test/script/foo/bar", "test/script/foo/bar~", "test/script/foo/baz", "test/script/nocomment", "test/script/README", "test/shlauncher_test.rb", "test/tractor_test.rb", "lib/shlauncher", "lib/shlauncher/base.rb", "lib/shlauncher/shlauncher.rb", "lib/shlauncher/tractor.rb", "lib/shlauncher.rb", "templates/bin", "templates/bin/shlauncher", "templates/ChangeLog", "templates/lib", "templates/lib/version.rb", "templates/Rakefile", "templates/README"]
  s.homepage = %q{}
